  ...
  return (
    ...
    >
      ...
      {Experiences_data.map((e) => (
        <div
          className={`exp bg-gray-100/90 p-2 flex flex-col gap-3`}
          key={e.id}
        >
          <span className={`text-lg md:main-font-size font-semibold`}>
            {" "}
            {e.job_title}
          </span>
          <span
            className={`flex items-center gap-10 max-sm:flex-col max-sm:gap-3`}
          >
